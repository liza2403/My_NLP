...
Надалі розглядається удосконалення системи за рахунок можливості оперування рішеннями для великих даних та розрідженою інформацєю. Дані тесту узяті з BBC НОВИНИ (бул обраний саме цей дата-сет, бо це єдиний портал, новинні з відсортованими новинними сегментами) !!!!!!!!!!! набору даних. Система дотримується методів підвищенної точності, а покращення продуктивності на даний момент не було в пріорітеті. NRS буде настільною програмою, що надає кінцевими користувачами пропозиції, відсортовані для них.

## <a name="l5">Підходи та способи вирішення завдання</a>

На сьогодні рішення задач NLP поділяються на ті, що пов'язані зі звичайним машинним навчанням (моделі логістичної регресії, "випадковий ліс") та глибоким, завдяки якому на даний момент вирішуються більшість задач, пов'язаних з класифікацією текстів, моделюванням мов, розпізнаванням мови, генерацією підписів, машинним перекладом, узагальненням документів і тд.
...
Це додаткове розуміння було б дуже корисним, якщо б потрібно було написати частину змісту про плавання і хотіти, щоб його класифікували за пошуковим терміном "як плавати". 
Якщо застосувати цей тип аналізу до сторінки результатів пошукової системи (SERP), можна швидко зрозуміти, які терміни та теми розглядаються як ті, що пов’язані з основним ключовим словом, яке було вписано у пошуку. Проведення аналізу TF-IDF для сторінок, що займають 10 найкращих позицій бажаного SERP, є дуже ціннним тоді, коли людину цікавить, що вона має додати до свого документи, аби її стаття була релевантною та гідною того, щоб її було розміщено на першій сторінці за темою «як плавати», необхідно знайти ті терміни, що мають високі показники TF-IDF поряд з темою статті.
...
## <a name="l7">Тестування</a>
 

## <a name="l8">Висновки</a>
...
3. https://medium.com/dataseries/everything-to-get-started-with-nlp-3ccfbb7405a2
4. https://medium.com/dataseries/sentiment-classifier-using-tfidf-3ffce3f1cbd5
5. https://python.gotrained.com/tf-idf-twitter-sentiment-analysis/
