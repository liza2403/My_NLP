...
-**Стемінг** - відновлення слова до його кореневої форми;

-**Токенізація** - це розділення фрази, речення, абзацу або цілого текстового документа на менші одиниці, такі як окремі слова чи терміни.
...
В якості дата-сета для цієї роботи використовувався архів New York times (50,000 статей), оскільки це один з небагатьох структурованих архівів статей, що є в Інтернеті. 
...
Реалізація кожного з пунктів описана у [TF-IDF_NRS.ipynb](https://github.com/liza2403/My_NLP/blob/main/src/app/TF-IDF_NRS.ipynb)
...
Після реєстрації у базі данних та обрання "прочитаних статей" програма успішно виконується та надає список новин.

![image](https://user-images.githubusercontent.com/55504714/119245647-887dfc80-bb83-11eb-8b24-02818dadf2c5.png)


![image3](https://user-images.githubusercontent.com/55504714/119245157-af3a3400-bb7f-11eb-9f36-1644bd197f7c.png)
